  ...
  <div class="content-wrapper">
    ...
    <div style="margin-top: 50px;margin-left: 30px;">
      <form action="starter.html">
        ...
        <label>UserID:</label><input  type="text" required></br></br>
        <label>Contact Number:</label><input  type="text" required></br></br>
        <label>E-mail Address:</label><input  type="E-mail" required></br></br>
