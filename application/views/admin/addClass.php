...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Database</span>
  ...
  <div class="content-wrapper">
    ...
    <div class="centered">
      <h1 style="font-family: courier;"><b>Add a Class</b></h1>
    </div>

    <div style="margin-top: 50px;margin-left: 30px;">
      <form action="starter.html">
        <label>School name:</label><input  type="text" required></br></br>
        <label>School ID:</label><input  type="text" required></br></br>
        <label>Class name:</label><input  type="text" required></br></br>
        <label>Class ID:</label><input  type="text" required></br></br>
