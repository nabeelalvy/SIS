  ...
  <div class="content-wrapper">
    <section class="content container-fluid">
      ...
      <div style="margin-top: -30px; margin-left: -13px;">
        <div id="bg" style="background-image: url(<?php echo base_url();?>assets/images/lbg.jpg); position: relative; width: auto; height: 300px; ">
          <div class="centered">
            <h1 style="font-family: courier; font-size: 2.2em;">School Information System</h1>
          </div>
        </div>
      </div>
