...
<body id="page-top">
    ...
    <header>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 text-center">
                        ...
                        <hr class="light">
                        <p class="text-faded">School Information System will help you solve the problem of searching
                            best school for your child. It also helps your child about choosing his desired field in
                            future. So GET STARTED...</p>
                        <a href="login" class="page-scroll btn btn-default btn-xl sr-button">Login</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 text-center" style="margin-left: 25%;">
